...
otm_ce_name, pe_name, ce_OTM_strike, pe_OTM_strike = tsl.OTM_Strike_Selection(
    "NIFTY", "05-09-2024", 3
)
ce_name, pe_name, ce_ITM_strike, pe_ITM_strike = tsl.ITM_Strike_Selection(
    "NIFTY", "05-09-2024", 4
)
...
orderid1 = tsl.order_placement(
    "NIFTY 29 AUG 24500 CALL", "NFO", 25, 0.05, 0, "LIMIT", "BUY", "MIS"
)
orderid2 = tsl.order_placement(
    "BANKNIFTY 28 AUG 51600 CALL", "NFO", 15, 0.05, 0, "LIMIT", "BUY", "MIS"
)
